...
function Header({ data }) {
  return (
    ...
    >
      ...
      <p className="text-white mt-3 mb-5 text-sm">
      ...
      <Link to={`/${data.media_type}/details/${data.id}/trailer`} className="bg-[#6556CD] p-4 rounded font-semibold text-white text-md">Watch Trailer</Link>
    </div>
  );
}
